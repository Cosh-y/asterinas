...
use ostd::mm::{Frame, FrameAllocOptions, PAGE_SIZE, VmIo, HasPaddr, };
use ostd::arch::virt::*;

use crate::emulate::cr::{sanitize_guest_cr0, sanitize_guest_cr4};
use crate::error::*;
use crate::vcpu::VcpuMsrs;
...
impl Vmcs {
    ...
    pub fn init(&self, vmcs_guest_state: VmcsGuestState, eptp: u64) -> Result<()> {
